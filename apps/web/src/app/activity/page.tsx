    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex gap-2 mb-4">
          ...
          <Button
            variant={selectedContract === 'BNPL_CORE' ? 'default' : 'outline'}
            size="sm"
          ...
          <Button
            variant={selectedContract === 'LP_TOKEN' ? 'default' : 'outline'}
            size="sm"
          ...
          <Button
            variant={selectedContract === 'USDC_TOKEN' ? 'default' : 'outline'}
            size="sm"
