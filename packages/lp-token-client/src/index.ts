...
export const networks = {
  testnet: {
    ...
    contractId: "CAX6EIH57YFHFLMIOT52XHB6NQO3DXEDTRV2EUNR7UMCUY43OC6INZBZ",
  }
} as const
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAADERlcG9zaXRFdmVudAAAAAMAAAAAAAAABmFtb3VudAAAAAAACwAAAAAAAAANc2hhcmVzX21pbnRlZAAAAAAAAAsAAAAAAAAABHVzZXIAAAAT",
        "AAAAAQAAAAAAAAAAAAAADVdpdGhkcmF3RXZlbnQAAAAAAAADAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAAAAAADXNoYXJlc19idXJuZWQAAAAAAAALAAAAAAAAAAR1c2VyAAAAEw==",
